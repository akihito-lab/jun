            ...
            <div class="mask">
                <section class="book-story-section">
                    <div class="inner">
                        ...
                        しかし彼の態度ははっきりしない。<br><br>
                        愛子の想いは物理的な距離を越えてますます燃え上っていく。<br>
                        しかしその一途な愛はすれ違い、恋愛裁判へと向かってしまうのだった。<br><br><br><br><br>
                        そして1995年1月17日がやってくる....。<br><br><br><br><br>
                        事実をもとに書き上げた、1人の女性の切ない愛の物語。</p>
                        <p class="desc-big">あわただしい運命に翻弄された<br>一人の女性の切なく儚い愛の流転<br>感動のノンフィクション物語</p>
                    </div>
                </section>
                    ...
                    <div class="inner">
                        ...
                        <ul class="list">
                            <li class="item">
                                ...
                                <div class="desc">『あなたに逢いたくて』まさかまさかのストーリー。
                                これがノンフィクションとは。愛子にとっては一途な恋愛。しかし賢志とっては…150ページの文庫本で、さくさく読めます。作者様次回作楽しみにしております！</div>
                            </li>
                            <li class="item">
                                <h3 class="title">こんな人生も面白いかも</h3>
                                <div class="desc">主人公の愛子は普通のＯＬの女性なのですがが、運命のイタズラとも言うのだろうか、思いもよらない結果を招いてしまう。普通の人生ではあまり経験出来ない現実を、一生懸命に生きようとする愛子の姿に好感が持てました。いろんな背景が描かれており、非現実的世界に引き込まれました。</div>
                            </li>
                            <li class="item">
                                <h3 class="title">独りよがりの恋愛は良くないなという印象</h3>
                            ...
                            <li class="item">
                                <h3 class="title">久しぶりに読んだ恋愛小説</h3>
                                <div class="desc">私はまだ生まれていない時代ですが、携帯のない時代の恋愛を知らない世代ですが、それも新鮮で短編なのでサクッと読めました。読み終わってから表紙を見て気付いた帯にノンフィクションの記載が、、、、、自分じゃ絶対真似できない！笑</div>
                            </li>
                        </ul>
                    </div>
                </section>
            ...
            <div class="inner">
                <div class="book-store-wrapper">
                    ...
                    <div class="text">
                        ...
                        <div class="book-detail">発刊日：2021/06/15 &nbsp;定価：660円 (本体 600円) &nbsp;判型：A6並 &nbsp;ページ数：156</div>
